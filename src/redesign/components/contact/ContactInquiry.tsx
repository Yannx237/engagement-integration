        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-8 sm:p-12 shadow-xl border border-stone-200/80">
            {formSubmitted ? (
              ...
              <form id="kontaktformular" onSubmit={handleSubmit} className="space-y-5 scroll-mt-40">
                ...
                <div>
                  ...
                  <select 
                    ...
                    onChange={(e) => onSubjectChange(e.target.value as ContactSubject)}
                  >
                    ...
                    <option value="shop">Bestellung Solidar-Shop (Merchandise)</option>
                  </select>
                </div>
