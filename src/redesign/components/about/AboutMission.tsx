                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-white font-medium hover:text-limeAccent-400 transition-colors"
                    >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-white font-semibold hover:text-limeAccent-400 transition-colors"
                    >
                      (+49) 0 177 3218743
                    </a>
                    <p className="text-xs text-stone-400 mt-0.5">
