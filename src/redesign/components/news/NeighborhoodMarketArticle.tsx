    ...
    <NewsArticle>
      <div className="max-w-3xl space-y-4 mb-8">
        ...
        <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
          Am 14. Mai fand der 1. Merklinder MitMachMarkt statt. Organisiert vom
          Quartiersmanagement Merklinde präsentierten sich insgesamt 21 Vereine
          und Institutionen mit vielfältigen Aktionen, Informationsständen und
          kulinarischen Spezialitäten. Unser Stand war ein beliebter Anlaufpunkt
          für Nachbarschaftsgespräche und direkte Integrationsberatung.
        </p>
      </div>
