    ...
    <NewsArticle>
      <div className="max-w-3xl space-y-4 mb-8">
        ...
        <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
          In Castrop-Rauxel veranstaltete unser Verein ein großes
          Willkommensfest für aus der Ukraine und weiteren Krisenregionen
          geflüchtete Familien. Im Mittelpunkt standen die Erstorientierung, die
          Vermittlung von Sprachkursen und kinderfreundliche Betreuungsangebote.
        </p>
      </div>
        ...
        photos={[
          {
            ...
            alt: 'Willkommensveranstaltung Ukraine 1',
          },
          {
            src: '/assets/images/news-6.png',
            alt: 'Willkommensveranstaltung Ukraine 2',
          },
          {
            src: '/assets/images/news-7.png',
            alt: 'Willkommensveranstaltung Ukraine 3',
          },
        ]}
