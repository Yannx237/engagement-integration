...
<NewsArticle>
          ...
          <NewsPhotoGallery photos={[
            ...
            ]} className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 pt-4 border-t border-stone-100" imageClassName="h-48 rounded-2xl overflow-hidden shadow-sm group" />
        </NewsArticle>
  );
}
