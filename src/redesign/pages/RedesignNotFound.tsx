      ...
      <div className="max-w-2xl w-full text-center space-y-8 bg-white p-8 sm:p-14 rounded-3xl border border-stone-200/80 shadow-xl relative overflow-hidden">
        ...
        <div className="space-y-4">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-800">
            Hier hat sich wohl ein Pfad verlaufen.
          </h2>
          <p className="text-slate-600 text-sm sm:text-base leading-relaxed max-w-lg mx-auto">
            Die von Ihnen aufgerufene Internetadresse existiert leider nicht, wurde umbenannt oder temporär verschoben. Nutzen Sie unsere Navigation, um wieder auf den richtigen Weg zu finden.
          </p>
        </div>
        ...
        <div className="pt-6 border-t border-stone-100 text-xs text-slate-500">
          Benötigen Sie sofortige Unterstützung? Schreiben Sie uns direkt an{' '}
          <a href="mailto:info@engagement-integration.de" className="text-brand-700 font-bold hover:underline">
