...
export const featuredProjects: readonly FeaturedProject[] = [
  {
    ...
    title: <>Tandem statt Barriere</>,
    description: (
      <>
        Gemeinsam mobil werden: Fahr- &amp; Sicherheitstrainings für Menschen
        mit und ohne Behinderung jeden Alters. Fahrräder &amp; Begleitung
        vorhanden.
      </>
    ),
    footer: (
      <>
        <span className="text-limeAccent-300 font-semibold">
          Sa 11:00–13:00 Uhr
        </span>
        <a
  ...
  },
  {
    ...
    title: <>Digitale Orientierung im Alltag</>,
    description: (
      <>
        Für geflüchtete &amp; zugewanderte Frauen: Online-Termine bei
        Bürgeramt/Jobcenter, Dokumente scannen, Kita-Apps &amp; Postfach
    ...
    footer: (
      <>
        ...
        <a
          className="font-bold text-limeAccent-400 hover:text-white transition-colors"
          href="#kontakt"
        >
          Anmelden →
        </a>
  ...
  },
  {
    ...
    title: <>Kostenfreie Nachhilfe</>,
    description: (
      <>
        Qualifizierte Begleitung in Deutsch, Französisch, Mathematik und
        Englisch für Kinder aller Altersstufen in Castrop-Rauxel und Dortmund.
      </>
    ),
    footer: (
      <>
  ...
  },
  {
    ...
    title: <>Frauencafé Castrop-Rauxel</>,
    description: (
      <>
        Ein geschützter Raum zum Kennenlernen, Deutsch sprechen, Erfahrungen
        austauschen und Kraft tanken bei Kaffee &amp; guten Gesprächen.
      </>
    ),
    footer: (
      <>
